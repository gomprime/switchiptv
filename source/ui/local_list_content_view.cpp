...
LocalListContentView::LocalListContentView(std::vector<iptv::FavoriteItem> items,
    ...
    // Respiro pra barra de rolagem da borealis não ficar sob o destaque de
    // foco (ver mesmo ajuste/comentário em catalog_content_view.cpp).
    recycler->setPaddingRight(20);

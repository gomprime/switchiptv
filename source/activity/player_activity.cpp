...
brls::View* PlayerActivity::createContentView() {
    ...
    if (!isLive) {
        ...
        timeLabel->setMarginLeft(20);
        timeLabel->setText("--:-- / --:--");
        headerBox->addView(timeLabel);
    }
    ...
    if (!isLive) {
        ...
        progressBarBox->setMarginLeft(20);
        progressBarBox->setMarginRight(20);
        progressBarBox->setMarginBottom(10);

        brls::Rectangle* progressBarBg = new brls::Rectangle(nvgRGBA(255, 255, 255, 60));
        progressBarBg->setWidth(brls::Application::contentWidth - 40);
        progressBarBg->setHeight(6);
        progressBarBox->addView(progressBarBg);

        progressBarFill = new brls::Rectangle(nvgRGB(0, 160, 220));
        ...
        rootBox->addView(progressBarBox);
    }
